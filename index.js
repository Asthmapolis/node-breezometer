...
const pollen        = require('./lib/pollen');
...
module.exports = function breezometerClientConstructor(options){
    ...
    let airQualityFx = airQuality.airQualityConstructor(options);
    let pollenFx = pollen.pollenConstructor(options);

    return _.extend(airQualityFx, pollenFx);
};